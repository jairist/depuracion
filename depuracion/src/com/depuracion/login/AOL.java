...
public class AOL {
	...
	public void beforeMethod() throws Exception {
		System.setProperty("webdriver.gecko.driver", new File("").getAbsolutePath() + "\\tools\\chromedriver.exe");
		System.out.println(new File("").getAbsolutePath().toString()+ "\\tools\\chromedriver.exe");
